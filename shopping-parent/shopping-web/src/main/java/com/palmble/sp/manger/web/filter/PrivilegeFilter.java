...
import com.palmble.sp.manger.web.controller.SpringBeanUtils;
...
public class PrivilegeFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		/*if(baseMenuService==null) {
			baseMenuService=(BaseMenuService) SpringBeanUtils.getBean("baseMenuServiceImpl");
		}*/
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		/* if(userPermissionService==null) {
			 userPermissionService =(UserPermissionService)SpringBeanUtils.getBean("userPermissionServiceImpl");
		 }*/
